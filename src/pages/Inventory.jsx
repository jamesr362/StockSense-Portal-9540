...
export default function Inventory() {
  ...
  const handleScannedItems = async (scannedItems) => {
    ...
    const limitCheck = canAddInventoryItem(totalItemsAfter - 1);
    ...
    >
      ...
      {currentPlan === 'free' && (isAtLimit || isNearLimit) && (
        <motion.div
          ...
          animate={{ opacity: 1, y: 0 }}
          className={`mb-4 rounded-lg p-4 border flex-shrink-0 ${
            isAtLimit 
      ...
      <div className="flex-1 min-h-0 w-full">
        {isLoading ? (
          ...
          <div className="h-full w-full bg-gray-800 rounded-lg shadow-xl border border-gray-700 flex flex-col">
            {/* Table Header */}
            ...
            {/* Table Footer */}
            <div className="px-6 py-3 border-t border-gray-700 bg-gray-750 flex-shrink-0">
