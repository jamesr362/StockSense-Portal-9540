...
export default function TaxExports() {
  ...
  const getFormatIcon = (format) => {
    switch (format) {
      case 'excel':
        return <RiFileTextLine className="h-4 w-4 text-green-400" />;
      case 'csv':
        return <RiFileTextLine className="h-4 w-4 text-blue-400" />;
      case 'pdf':
        return <RiFileTextLine className="h-4 w-4 text-red-400" />;
      default:
          ...
          <div className="bg-gray-800 rounded-lg p-8 border border-gray-700">
            <div className="text-center">
              ...
              <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
                Tax export functionality is available exclusively with the Professional plan. Generate comprehensive, accountant-ready reports with detailed VAT calculations, category breakdowns, and professional formatting.
              </p>
              ...
              <div className="mt-8 pt-8 border-t border-gray-700">
                ...
                <p className="text-gray-500 text-xs mt-2">
                  All features included • No setup fees • 30-day money-back guarantee
                </p>
              </div>
            </div>
          </div>
  ...
  if (isLoading) {
    return (
      <div className="flex items-center justify-center h-64">
        ...
        <span className="ml-2 text-white">Loading tax export data...</span>
      </div>
    );
  }
        ...
        <div className="mb-6 bg-gradient-to-r from-green-600/20 to-primary-600/20 rounded-lg p-4 border border-green-500/30">
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-gray-300 text-sm">You have access to comprehensive tax export functionality</p>
            </div>
          </div>
        </div>
          ...
          <div className="px-4 py-5 border-b border-gray-700 sm:px-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="mt-1 max-w-2xl text-sm text-gray-400">
                  Your recent tax export downloads
                </p>
              </div>
            ...
            {exportHistory.length === 0 ? (
              <div className="text-center py-12">
                ...
                <p className="text-gray-400 text-sm mb-6">
                  Generate your first tax export to build your export history
                </p>
                <button
                  onClick={() => setIsExportModalOpen(true)}
          ...
          <div className="flex items-start">
            ...
            <div>
              ...
              <ul className="text-blue-300 text-sm space-y-1">
                ...
                <li>• Keep export records for HMRC compliance and audit purposes</li>
              </ul>
            </div>
          </div>
        </div>
