...
// CRITICAL: Re-check limits before submission (in case they changed)
// We need to get the current inventory count, but we'll approximate with a call to canAddInventoryItem
const limitCheck = canAddInventoryItem(0); // This will get current usage internally
...
Free plan: Limited to 100 manual inventory entries
</p>
</div>
</div>
)}
